...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sale_cancels', function (Blueprint $table) {
            ...
            $table->decimal('special_discount_value', 10, 2)->default(0);
            ...
            $table->decimal('couponCodeDiscountValue', 10, 2)->default(0);
            $table->decimal('couponCodeDiscountAmount', 10, 2)->default(0);
            $table->decimal('membership_discount_percentage', 10, 2)->default(0);
