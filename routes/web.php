...
Route::middleware(['auth', 'prevent_duplicate_submission'])->group(function () {
    ...
    Route::resource('production-recipes', \App\Http\Controllers\ProductionRecipeController::class);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('fund-transfer-vouchers-export', [App\Http\Controllers\FundTransferVoucherController::class, 'export'])->name('fund-transfer-vouchers.export');
