...
class FactoryDeliveryExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithEvents, ShouldAutoSize
{
    ...
    {
        return $array = [
            $row->requisition->outlet ? $row->requisition->outlet->name : '',
            $row->requisition->outlet ? $row->requisition->outlet->address : '',
            // $row->date,
            $row->delivery_number,
            $row->comments,
            $row->status,
