...
class OutletReceiveExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithEvents, ShouldAutoSize
{
    ...
    public function map($row): array
    {
        return $array = [
            $row->date,
            $row->delivery?$row->delivery->delivery_number:'',
            $row->delivery?$row->delivery->status:'',
            $row->rr_number,
            $row->total_amount,
            $row->total_quantity,
            $row->description,
