@extends('layouts.app')
@section('title')
    RM Inventory Transfer Receive List
@endsection
@section('content')
    @php
        $links = [
    ...
    @endphp
    <x-breadcrumb title="RM Inventory Transfer Receive" :links="$links"/>
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('rm-transfer-receives.create') }}" class="btn btn-sm btn-primary">
        ...
        $(document).ready(function () {
            $('#dataTable').dataTable({
                ...
                columns: [
                    ...
                    {data: "uid", title: "RMITR No", searchable: true, defaultContent: "—"},
                    {data: "inventory_transfer.uid", name: "inventoryTransfer.uid", title: "Transfer UID", searchable: true, defaultContent: "—"},
