...
@section('content')
    ...
    @endphp
    <x-breadcrumb title='RM Inventory Transfer Receive Entry' :links="$links"/>
    <!-- Main content -->
                    ...
                    <form action="{{ route('rm-transfer-receives.store') }}" method="POST" class="">
                        ...
                        <div class="card">
                            <div class="card-header bg-info">
                                <h3 class="card-title">RM Inventory Transfer Receive Entry</h3>
                        ...
                        <div class="card">
                            <div class="card-header bg-info">
                                <h3 class="card-title">RM Transfer Receive Line Item</h3>
                            </div>
                            <div class="card-body">
                                <div class="card-box">
                                    <div id="">
