                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-12 mb-1">
                                        <x-forms.select label="Chart Of Account" inputName="coa_id" placeholder="Select One" :isRequired='true'  :isReadonly='false' defaultValue="" :options="$chartOfAccounts" optionId="id" optionValue="name"/>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-3 col-12 mb-1">
                                        <x-forms.static-select label="Type" inputName="type" placeholder="Select One" :isRequired='true'  :isReadonly='false' :defaultValue="isset($outletAccount) ? $outletAccount->status : ''" :options="['Cash','Bkash','Nagad','Rocket','Upay','DBBL','UCB','Nexus','PBL','Due','FoodPanda','CityBank','PBLQR','FOODIE']"/>
                                    </div>
                                </div>
                            </div>
