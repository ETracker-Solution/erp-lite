        ...
        <div class="container-fluid">
            <div class="row" id="vue_app">
                ...
                <div class="col-lg-12 col-md-12">
                    <form action="{{ route('payment-vouchers.update', $voucher->id) }}" method="POST" class=""
                        ...
                        <div class="card">
                            <div class="card-header bg-info">
                                <h3 class="card-title">Payment Voucher (PV) Edit - {{ $PVno }}</h3>
        ...
        $(document).ready(function () {
            ...
            var vue = new Vue({
                ...
                data: {
                    ...
                    payee_name: '',
                    amount: '',
                    selected_items: {!! json_encode($paymentVouchers->map(function($pv) {
                        return [
                            'id' => rand(1000, 9999),
                            'from_account_id' => $pv->credit_account_id,
                            'from_account_name' => $pv->cashBankAccount->name,
                            'to_account_id' => $pv->debit_account_id,
                            'to_account_name' => $pv->debitAccount->name,
                            'amount' => $pv->amount,
