        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <form action="{{ route('payment-vouchers.store') }}" method="POST" class="prevent-enter-submit">
                        @csrf
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title mb-0">New Payment Voucher</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="uid">PV No <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="uid" name="uid"
                                                   value="{{ old('uid', $PVno) }}" readonly>
                                            @error('uid')
