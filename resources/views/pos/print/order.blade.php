...
<body>
    ...
    <htmlpageheader name="page-header">
        <table style="border: 2px solid #fff;">
            ...
            <tr>
                <td class="bb-none tc">
                    <p style="font-size: 10px;" class="tc text-bold mm10">Customer Care: +880 1760-606081</p>
                </td>
            </tr>
            <tr>
                <td class="bb-none tc">
            ...
            {{-- <tr>--}}
                {{-- <td class="bb-none tc">
                    <p style="font-size: 10px;" class="tc text-bold mm10"><u>{{ $sale->outlet->name }}--}}
                            {{-- Invoice</u></p>
                </td>--}}
                {{-- </tr>--}}
        </table>
    ...
    <table style="border: 1px solid #000;">
        ...
        @php
            ...
            if (isset($sale->membershipPointHistory[0])) {
                $earned_point = $sale->customer->type == 'regular' && $sale->membershipPointHistory[0] && $sale->membershipPointHistory[0]->customer_id == $sale->customer_id && $sale->membershipPointHistory[0]->member_type_id != 1 ? $sale->membershipPointHistory()->where('point', '>', 0)->first()->point : 0;
                $current_point = $sale->customer->type == 'regular' && $sale->customer && $sale->customer->membership && $sale->membershipPointHistory[0]->customer_id == $sale->customer_id && $sale->customer->membership->member_type_id == $sale->membershipPointHistory[0]->member_type_id && $sale->customer->id != 1 ? $sale->customer->currentReedemablePoint() : 0;
            }
