                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">RM Inventory Transfer List</h3>
                            <div class="card-tools">
                                <a href="{{ route('rm-inventory-transfers.create') }}" class="btn btn-sm btn-primary">
    ...
    <script>
        $(document).ready(function () {
            $('#dataTable').dataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('rm-inventory-transfers.index') }}",
                },
                columns: [
