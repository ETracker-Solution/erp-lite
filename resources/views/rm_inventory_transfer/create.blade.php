...
@section('content')
    ...
    @php
        ...
        'RM Inventory Transfer list'=>''
        ]
    @endphp
    <x-breadcrumb title='RM Inventory Transfer Entry' :links="$links"/>
    <!-- Main content -->
        ...
        <div class="container-fluid">
            <div class="row" id="vue_app">
                ...
                <div class="col-lg-12 col-md-12">
                    <form action="{{ route('rm-inventory-transfers.store') }}" method="POST" class="">
                        @csrf
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">RM Inventory Transfer(RMIT) Entry </h3>
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary"
                                       href="{{route('rm-inventory-transfers.index')}}">
                                        <i class="fa fa-list" aria-hidden="true"></i> &nbsp;RM Inventory Transfer List
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">RMT Item Information</h3>
                                <div class="card-tools">
