...
@section('title', 'RM Inventory Transfer Entry')

@section('content')
    @php
        $links = [
            'Home' => route('dashboard'),
            'RM Inventory Transfer' => route('rm-inventory-transfers.index'),
            'Create' => '',
        ];
    @endphp
    <x-breadcrumb title="RM Inventory Transfer" :links="$links"/>

    <section class="content">
        <div class="container-fluid">
            <div class="row" id="vue_app">
                <div class="col-lg-10 offset-lg-1">
                    <form action="{{ route('rm-inventory-transfers.store') }}" method="POST" class="prevent-enter-submit">
                        @csrf
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title mb-0">New RM Inventory Transfer</h3>
                                <div class="card-tools">
                                    <a href="{{ route('rm-inventory-transfers.index') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body">
                                <p class="text-muted small mb-3">
                                    Move RM stock between stores. UID generates on save. Receive later from pending list.
                                </p>
                                    ...
                                    <table class="table table-bordered table-sm mb-0">
                                        ...
                                        <tr v-if="items.length === 0">
                                            <td colspan="9" class="text-center text-muted py-4">
                                                Select from store, group + item, then Add Item.
                                            </td>
                                        </tr>
                ...
                methods: {
                    ...
                    data_input: function () {
                        ...
                        if (String(vm.from_store_id) === String(vm.to_store_id)) {
                            toastr.error('From and To store must differ', {closeButton: true, progressBar: true});
                            return;
                        }
                        if (!vm.item_id) {
                        ...
                        axios.get(this.config.get_item_info_url + '/' + vm.item_id, {
                            params: {store_id: this.from_store_id}
                        }).then(function (response) {
