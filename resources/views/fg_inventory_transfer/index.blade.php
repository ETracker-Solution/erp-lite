@extends('layouts.app')
@section('title', 'FG Inventory Transfer List')
...
@section('content')
    ...
    @endphp
    <x-breadcrumb title="FG Inventory Transfer List" :links="$links"/>
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">FG Inventory Transfer List</h3>
                            <div class="card-tools">
                                <a href="{{ route('fg-inventory-transfers.create') }}" class="btn btn-sm btn-primary">
        ...
        $(document).ready(function () {
            $('#dataTable').dataTable({
                ...
                columns: [
                    ...
                    {data: "uid", title: "FGIT No", searchable: true, defaultContent: "—"},
