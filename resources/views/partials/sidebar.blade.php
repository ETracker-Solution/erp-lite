        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li
                        ...
                        <ul class="nav nav-treeview second-child">
                            @canany(['accounts-receive-voucher', 'accounts-payment-voucher', 'accounts-journal-voucher', 'accounts-ft-voucher', 'accounts-delivery-cash-transfer', 'accounts-delivery-cash-receive', 'accounts-supplier-voucher'])
                                <li
                                    class="nav-item {{ (Request::segment(1) == 'receive-vouchers' || Request::segment(1) == 'supplier-dues'  || Request::segment(1) == 'payment-vouchers' || Request::segment(1) == 'journal-vouchers' || Request::segment(1) == 'fund-transfer-vouchers' || Request::segment(1) == 'delivery-cash-transfers' || Request::segment(1) == 'delivery-cash-receives' || Request::segment(1) == 'supplier-vouchers') ? 'menu-open' : ''}}">
                                    <a href="#"
                                       class="nav-link {{ (Request::segment(1) == 'receive-vouchers' || Request::segment(1) == 'supplier-dues'  || Request::segment(1) == 'payment-vouchers' || Request::segment(1) == 'journal-vouchers' || Request::segment(1) == 'fund-transfer-vouchers' || Request::segment(1) == 'delivery-cash-transfers' || Request::segment(1) == 'delivery-cash-receives' || Request::segment(1) == 'supplier-vouchers') ? ' active' : ''}}">
                    ...
                    <li
                        ...
                        <ul class="nav nav-treeview second-child">
                            ...
                            @canany(['sales-sales', 'sales-other-outlet-sales', 'sales-sales-delivery', 'sales-sales-exchanges'])
                                <li
                                    class="nav-item {{ (Request::segment(1) == 'sales' || Request::segment(1) == 'others-outlet-sales' || Request::segment(1) == 'sales-exchanges' || Request::segment(1) == 'sales-deliveries' || Request::segment(1) == 'sales-returns' || Request::segment(1) == 'sale-deleted-list' || Request::segment(1) == 'sale-deleted-show' || Request::segment(1) == 'customer-dues' || Request::segment(1) == 'customer-receive-vouchers') ? 'menu-open' : ''}}">
                                    <a href="#"
                                       class="nav-link {{ (Request::segment(1) == 'sales' || Request::segment(1) == 'others-outlet-sales' || Request::segment(1) == 'sales-exchanges' || Request::segment(1) == 'sales-deliveries' || Request::segment(1) == 'sales-returns' || Request::segment(1) == 'sale-deleted-list' || Request::segment(1) == 'sale-deleted-show' || Request::segment(1) == 'customer-dues' || Request::segment(1) == 'customer-receive-vouchers') ? ' active' : ''}}">
                                        <i class="nav-icon fa fa-folder-open"></i>
                                        <p>
                                        ...
                                        @can('sales-sales')
                                            <li class="nav-item">
                                                <a href="{{route('customer-receive-vouchers.index')}}"
                                                   class="nav-link {{ (Request::segment(1) == 'customer-receive-vouchers') ? ' active' : ''}}">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Customer Due Coll.</p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{route('customer-dues.index')}}"
                                                   class="nav-link {{ (Request::segment(1) == 'customer-dues') ? ' active' : ''}}">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Customer Due</p>
                                                </a>
                                            </li>
                ...
                @canany(['master-data-create-outlet', 'master-data-create-factory', 'master-data-designation', 'master-data-department', 'master-data-gl-account', 'master-data-raw-metarials', 'master-data-finish-goods', 'master-data-customer-ob', 'master-data-supplier-ob', 'master-data-supplier-group-list', 'master-data-supplier-list', 'master-data-inventory-item-list', 'master-data-unit-list', 'master-data-store-list', 'master-data-chart-of-accounts', 'master-data-outlet-accounts'])
                    <li
                        class="nav-item {{ (Request::segment(1) == 'chart-of-accounts' || Request::segment(1) == 'outlet-accounts' || Request::segment(1) == 'chart-of-inventories' || Request::segment(1) == 'units' || Request::segment(1) == 'stores' || Request::segment(1) == 'supplier-groups' || Request::segment(1) == 'suppliers' || Request::segment(1) == 'general-ledger-opening-balances' || Request::segment(1) == 'raw-materials-opening-balances' || Request::segment(1) == 'finish-goods-opening-balances' || Request::segment(1) == 'customer-opening-balances' || Request::segment(1) == 'supplier-opening-balances' || Request::segment(1) == 'factories' || Request::segment(1) == 'outlets' || Request::segment(1) == 'designations' || Request::segment(1) == 'departments' || Request::segment(1) == 'customers' || Request::segment(1) == 'production-recipes' || Request::segment(1) == 'recipes') ? 'menu-open' : ''}}">
                        <a href="#"
                        ...
                        <ul class="nav nav-treeview second-child">
                            ...
                            @canany(['master-data-inventory-item-list', 'master-data-unit-list', 'master-data-store-list'])
                                <li
                                    class="nav-item {{ (Request::segment(1) == 'chart-of-inventories' || Request::segment(1) == 'units' || Request::segment(1) == 'stores' || Request::segment(1) == 'alter_units' || Request::segment(1) == 'production-recipes' || Request::segment(1) == 'recipes') ? 'menu-open' : ''}}">
                                    <a href="#"
                                       class="nav-link {{ (Request::segment(1) == 'chart-of-inventories' || Request::segment(1) == 'units' || Request::segment(1) == 'stores' || Request::segment(1) == 'alter_units' || Request::segment(1) == 'production-recipes' || Request::segment(1) == 'recipes') ? ' active' : ''}}">
                                        <i class="nav-icon fa fa-folder-open"></i>
                                        <p>
                                            Inventory Setting
                                            <i class="right fas fa-angle-left"></i>
