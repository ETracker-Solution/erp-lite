...
<head>
    <title>RM Requisiton Delivery Pdf </title>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 top-right">
                                    <span class="marginright">{{ \Carbon\Carbon::parse($requisitionDelivery->created_at)->isoFormat('MMM Do, YYYY') }}</span>
                                </div>
                            </div>
                            <hr>
                            <table width="100%">
								<tbody>
									<tr>
										<td style="text-align: left; padding:8px; line-height: 1.6">
											...
											<p><b>Type :</b> {{ $requisitionDelivery->type }} </p>
