...
@section('title', 'RM Requisition Delivery Entry')

@section('content')
    @php
        $links = [
            'Home' => route('dashboard'),
            'RM Requisition Delivery' => route('rm-requisition-deliveries.index'),
            'Create' => '',
        ];
        ...
        <div class="container-fluid">
            <div class="row" id="vue_app">
                <div class="col-lg-10 offset-lg-1">
                    <form action="{{ route('rm-requisition-deliveries.store') }}" method="POST" class="prevent-enter-submit">
                        @csrf
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title mb-0">New RM Requisition Delivery</h3>
                            ...
                            <div class="card-body">
                                <p class="text-muted small mb-3">
                                    Deliver pending RM requisition from HO to factory. Delivery No generates on save.
                                </p>

                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="requisition_id">Requisition (RMR) <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="from_store_id">From Store (HO) <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="to_store_id">To Store (Factory) <span class="text-danger">*</span></label>
                                    ...
                                    <table class="table table-bordered table-sm mb-0">
                                        ...
                                        <tr v-if="!pageLoading && items.length === 0">
                                            <td colspan="8" class="text-center text-muted py-4">
                                                Select a pending requisition to load lines.
                                            </td>
                                        </tr>
                    ...
                    onRequisitionChange: function () {
                        ...
                        axios.get(this.config.get_old_items_data + '/' + vm.requisition_id)
                            .then(function (response) {
                                // Delivery: HO (requisition.to) -> Factory (requisition.from)
