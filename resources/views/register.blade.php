        ...
        <div class="card">
            <div class="card-body register-card-body">
                <form action="{{ route('registers.store') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <textarea class="form-control" name="address" id="" cols="5" rows="2" placeholder="Company Address">{{ old('address') }}</textarea>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="no_of_employee" class="form-control" value="{{ old('no_of_employee') }}"
