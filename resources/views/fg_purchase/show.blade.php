...
@section('title', 'Finish Goods Purchase Details')

@section('content')
    @php
        $links = [
            'Home' => route('dashboard'),
            'Finish Goods Purchase' => route('fg-purchases.index'),
            'Details' => '',
        ];
    ...
    @endphp
    <x-breadcrumb title="Finish Goods Purchase Details" :links="$links"/>
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title mb-0">
                                FGP {{ $purchase->uid ?: ('#'.$purchase->id) }}
                                <span class="ml-2">{!! showStatus($purchase->status) !!}</span>
                            </h3>
                            <div class="card-tools">
                                <a href="{{ route('fg-purchases.index') }}" class="btn btn-sm btn-primary">
