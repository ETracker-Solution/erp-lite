...
@section('content')
    ...
    @endphp
    <x-breadcrumb title='Finish Goods Purchase' :links="$links"/>
    <!-- Main content -->
                    ...
                    <div class="card">
                        <div class="card-header bg-info">
                            ...
                            <div class="card-tools">
                                <a href="{{route('fg-purchases.create')}}">
                        ...
                        <div class="card-body">
                            <div class="row mb-3 align-items-end">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" id="uid" class="form-control filter-input" placeholder="Purchase No">
                                </div>
                                <div class="col-md-2">
