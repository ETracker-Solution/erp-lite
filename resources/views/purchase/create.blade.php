                    ...
                    var vue = new Vue({
                        ...
                        computed: {
                            ...
                            subtotal: function () {
                                return this.selected_items.reduce((total, item) => {
                                    const quantity = item.alter_unit ? parseFloat(item.quantity) : parseFloat(item.a_unit_quantity);
                        ...
                        methods: {
                            ...
                            itemtotal: function (index) {
                                const quantity = index.alter_unit ? parseFloat(index.quantity) : parseFloat(index.a_unit_quantity);
                                const rate = parseFloat(index.rate);
                                return quantity * rate;
                            },
                            convertedUnit: function (index) {
                                let unitQty = (index.quantity ? parseFloat(index.quantity) : 1) * parseFloat(index.a_unit_quantity);
