...
@section('content')
    ...
    @endphp
    <x-breadcrumb title='Customer OB' :links="$links"/>
        ...
        <div class="container-fluid">
            <div class="row" id="vue_app">
                ...
                <div class="col-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <label for="item_id">COB ID</label>
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <div class="card-title">Customer Opening Balance List</div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                ...
                methods: {
                    ...
                    update_balance() {
                        ...
                        if (!vm.editableItem) {
                            ...
                            if (slug) {
                                vm.pageLoading = true;
                                axios.put(this.config.COBUrl + '/' + slug, {
                                    date: vm.date,
                                    item_id: vm.item_id,
                                    remarks: vm.remarks,
                                    amount: vm.amount,
                    ...
                    get_initial_data() {
                        ...
                        axios.get(this.config.initial_info_url).then(function (response) {
                            vm.items = response.data.customers;
