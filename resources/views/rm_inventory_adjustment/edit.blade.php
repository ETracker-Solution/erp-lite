...
@section('content')
    ...
    @endphp
    <x-breadcrumb title='RM Inventory Adjustment Edit' :links="$links"/>
    <!-- Main content -->
        ...
        <div class="container-fluid">
            <div class="row" id="vue_app">
                ...
                <div class="col-lg-12 col-md-12">
                    <form action="{{ route('rm-inventory-adjustments.update', $RMInventoryAdjustment->id) }}" method="POST" class="">
                        @csrf
                        @method('PUT')
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">RM Inventory Adjustment(RMIA) Edit </h3>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group">
                                                    <label for="serial_no">RMIA No</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control input-sm"
                                                               value="{{$RMInventoryAdjustment->uid}}" name="serial_no"
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-sm"
                                                           value="{{$RMInventoryAdjustment->reference_no}}" name="reference_no">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="remark" rows="1"
                                                              placeholder="Enter Remark">{{$RMInventoryAdjustment->remark}}</textarea>
                                                </div>
                                            </div>
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">RMIA Item Information</h3>
                            </div>
        ...
        $(document).ready(function () {
            ...
            var vue = new Vue({
                ...
                data: {
                    ...
                    date: "{{ $RMInventoryAdjustment->date }}",
                    transaction_type: "{{ $RMInventoryAdjustment->transaction_type }}",
                    store_id: "{{ $RMInventoryAdjustment->store_id }}",
                    category_id: '',
                    item_id: '',
                    products: [],
                    items: {!! json_encode($RMInventoryAdjustment->items->map(function($item) {
                        return [
                            'coi_id' => $item->coi_id,
