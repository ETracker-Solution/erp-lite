        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    {!! BootForm::open(['model' => $model, 'store' => 'supplier.store', 'update' => 'supplier.update','class'=>'form-horizontal']);
                    !!}

                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                {!! BootForm::text('name', ' Name (Must be unique)', null,
                                ['placeholder'=>'Enter name','required'=>'required'] ) !!}
                            </div>

                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                {!! BootForm::text('mobile', ' Mobile (Must be unique)', null,
