...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            if (sessionStorage.getItem('date_range_production_recipe')) {
                $('#date_range').val(sessionStorage.getItem('date_range_production_recipe'));
            }
            if (sessionStorage.getItem('recipe_no_production_recipe')) {
                $('#recipe_no').val(sessionStorage.getItem('recipe_no_production_recipe'));
            }
            if (sessionStorage.getItem('product_production_recipe')) {
                $('#product').val(sessionStorage.getItem('product_production_recipe'));
            }
            ...
            $('.filter-input').on('keyup change', function () {
                sessionStorage.setItem('date_range_production_recipe', $('#date_range').val());
                sessionStorage.setItem('recipe_no_production_recipe', $('#recipe_no').val());
                sessionStorage.setItem('product_production_recipe', $('#product').val());
                recallDatatable();
            });
            ...
            $('#reset-btn').on('click', function () {
                ...
                sessionStorage.removeItem('date_range_production_recipe');
                sessionStorage.removeItem('recipe_no_production_recipe');
                sessionStorage.removeItem('product_production_recipe');
                recallDatatable();
            });
        })
    </script>
