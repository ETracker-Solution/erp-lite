                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <x-forms.static-select label="Status" inputName="status" placeholder="Select One" :isRequired='false'  :isReadonly='false' :defaultValue="$employee ? $employee->status : ''" :options="['active','inactive']"/>
                                    </div>
                                </div>
                            </div>
                        </div>
