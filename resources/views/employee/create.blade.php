                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <x-forms.static-select label="Status" inputName="status" placeholder="Select One"
                                        :isRequired='false' :isReadonly='false' defaultValue="active"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <x-forms.text label="Nominee Name" inputName="nominee_name"
                                        placeholder="Nominee Name" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <x-forms.static-select label="Blood Group" inputName="blood_group"
                                        placeholder="Select One" :isRequired='false' :isReadonly='false' defaultValue=""
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" name="dob" value="{{ date('Y-m-d') }}"
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <x-forms.text label="Nominee Relation" inputName="nominee_relation"
                                        placeholder="Nominee Relation" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <x-forms.text label="Bank Account" inputName="bank_account"
                                        placeholder="Enter Your Bank Account" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <x-forms.text label="Present Address" inputName="present_address"
                                        placeholder="Present Address" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <x-forms.text label="Permanent Address" inputName="permanent_address"
                                        placeholder="Permanent Address" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <x-forms.email label="Personal Email" inputName="personal_email"
                                        placeholder="Enter Personal Email" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <x-forms.text label="Alternative Contact" inputName="alternative_phone"
                                        placeholder="Enter Alternative Contact" :isRequired='false' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                            <input type="text" name="joining_date" value="{{ date('Y-m-d') }}"
                                                class="form-control datetimepicker-input"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                                            <input type="text" name="confirm_date" value="{{ date('Y-m-d') }}"
                                                class="form-control datetimepicker-input"
                                ...
                                <div class="col-xl-4 col-md-4 col-4 mb-1">
                                    ...
                                    <x-forms.select label="User Of" inputName="user_of" placeholder="Select One"
                                        :isRequired='true' :isReadonly='false' defaultValue="" :options="$user_of"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="outletDropdown" hidden>
                                    <x-forms.select label="Outlet" inputName="outlet_id" placeholder="Select One"
                                        :isRequired='false' :isReadonly='false' defaultValue="" :options="$outlets"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="factoryDropdown" hidden>
                                    <x-forms.select label="Factory" inputName="factory_id" placeholder="Select One"
                                        :isRequired='false' :isReadonly='false' defaultValue="" :options="$factories"
                                        optionId="id" optionValue="name" />
                                </div>
                            </div>
                        </div>
