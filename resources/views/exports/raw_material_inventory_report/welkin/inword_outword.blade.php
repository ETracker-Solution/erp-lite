...
<div class="header">
    ...
    @if(request()->has('from_date') && request()->has('end_date'))
        <p>{{ \Carbon\Carbon::parse(request()->from_date)->format('d-M-y') }}
            to {{ \Carbon\Carbon::parse(request()->end_date)->format('d-M-y') }}</p>
    @endif
</div>
...
<table>
    ...
    <tr style="border-top: 1px solid black">
        ...
        <th colspan="4" style="text-align: center; border-right: 1px solid black">In Wards</th>
        <th colspan="4" style="text-align: center; border-right: 1px solid black">Out Wards</th>
