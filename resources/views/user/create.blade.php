                ...
                <div class="col-5">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <select name="employee" id="employee" class="form-control select2" required>
                                        ...
                                        <option value="{{ $employee }}">{{ $employee->id . ' - '. $employee->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <x-forms.text label="Name" inputName="name" placeholder="Enter User Name"
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <x-forms.password label="Password" inputName="password" placeholder="Enter Password"
                                        :isRequired='true' :isReadonly='false' defaultValue="" />
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <x-forms.password label="Retype Password" inputName="password_confirmation"
                                        placeholder="Enter Password" :isRequired='true' :isReadonly='false'
                                        defaultValue="" />
                                </div>
                            </div>
