...
<div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('journal-vouchers.store') }}" method="POST" class="prevent-enter-submit"
                                                ...
                                                <div class="col-xl-4 col-md-4 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2"
                                                            name="debit_account_id" id="debit_account_id">
                                                            <option value="">---Select Account---</option>
                                                            @foreach ($chartOfAccounts as $row)
                                                                <option value="{{ $row->id }}"
                                                                    {{ old('debit_account_id') == $row->id ? 'selected' : '' }}>
                                                                    {{ $row->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-xl-12 col-md-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="narration" id="narration" cols="" rows="3"
    ...
    <input type="hidden" id="journalVoucaher"  value="{{ $JVno }}"/>
</div>
</section>
<!-- Basic Inputs end -->
