                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    <label for="uid">FGRD No</label>
                                    <input type="text" id="uid" class="form-control filter-input" placeholder="FGRD No">
                                </div>
                                <div class="col-md-2">
                                    <label for="requisition_uid">FGR No</label>
                                    <input type="text" id="requisition_uid" class="form-control filter-input" placeholder="FGR No">
                                </div>
                                <div class="col-md-2">
        ...
        $(document).ready(function () {
            var table = $('#dataTable').DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        d.uid = $('#uid').val();
                        d.requisition_uid = $('#requisition_uid').val();
            ...
            $('#reset_btn').on('click', function () {
                ...
                if ($('#date_range').length > 0 && $('#date_range')[0]._flatpickr) {
                    // Re-initialize flatpickr to clear it properly
