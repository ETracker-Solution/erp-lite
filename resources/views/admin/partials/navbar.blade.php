        ...
        <li class="nav-item dropdown">
            <div class="user-panel d-flex" data-toggle="dropdown">
                <div class="image">
                    ...
                    @if (isset(Auth::guard('admin')->user()->image) && file_exists('upload/'.Auth::guard('admin')->user()->image))
                        <img src="{{ asset('/upload/'.Auth::guard('admin')->user()->image) }}" class="img-circle elevation-2"
                        alt="" style="height: 40px">
                    @else
                    <img src="{{ asset('admin/app-assets/dummy/dammy.jpg') }}"
                    class="img-circle elevation-2" alt="" style="height: 40px">
                    @endif
