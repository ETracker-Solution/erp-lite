                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Pre Order Entry</h3>
                            <div class="card-tools">
                                <a href="{{route('pre-orders.index')}}">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="fa fa-list" aria-hidden="true"></i> &nbsp;Pre Order List
                                    </button>
                                </a>
                            </div>
                        </div>
                                            ...
                                            <div class="col-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="delivery_point_id" id=""
                                                        ...
                                                        <option value="">None</option>
                                                        @foreach($outlets as $delivery_point)
                                                            <option
        ...
        $(document).ready(function () {
            var vue = new Vue({
                ...
                computed: {
                    ...
                    pay_left: function () {
                        return this.total_payable_bill > this.total_paying ? Number(this.total_payable_bill - this.total_paying).toFixed(2) : 0
                    },
                ...
                methods: {
                    ...
                    getStoreData() {
                        // Disabled for Pre Order to keep Order Number static
                    },
