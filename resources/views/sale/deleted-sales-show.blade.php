...
@section('content')
    ...
    @php
        ...
        'Deleted Sales Details'=>''
        ]
    @endphp
    <x-breadcrumb title='Deleted Sales Details' :links="$links"/>
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Deleted Sales Details</h3>
                        ...
                        <div class="row invoice-info">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="text-align: left; padding:8px; line-height: 0.6">
                                            <p><b>Outlet :</b> {{ $sale->outlet_name }}</p>
                                            <p><b>Customer Name
                                                    :</b> {{ $sale->customer_name ? $sale->customer_name : 'N/A' }} </p>
                                            <p><b>Customer Number
                                                    :</b> {{ $sale->customer_phone ? $sale->customer_phone ?? 'N/A' : 'N/A' }}
                                            </p>
                            ...
                            <div class="col-sm-4 invoice-col">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="text-align: left; padding:8px; line-height: 0.6">
                                            <p><b>Address :</b> {{ $sale->outlet_location }}</p>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="text-align: left; padding:8px; line-height: 0.6">
                                            ...
                                            <p><b>email :</b> {{ $sale->customer_email }} </p>
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ (floatval($item->unit_price) * $item->quantity) - $item->discount }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
